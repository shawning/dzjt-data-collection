...
public class ZipUtil {
	...
	/**
	 * 源文件夹加密压缩成zip
	 * @param srcfile 需要压缩的文件夹地址
	 * @param targetFile 压缩包地址名称
	 * @param password 压缩密码
	 */
    public  static void zipEncryptionFile(String srcfile, String targetFile,String password) {
    	try{
			//创建压缩文件
			net.lingala.zip4j.core.ZipFile zipFile = new net.lingala.zip4j.core.ZipFile(targetFile);
